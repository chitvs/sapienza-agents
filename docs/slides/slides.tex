...
\node[stage, right=of cache] (cls) {Classificazione\\intento};
...
\node[sub, below=1.2mm of cls]   {intento principale\\e secondari};
...
\draw[loop] ([xshift=4mm]est.north) .. controls +(0,7mm) and +(0,7mm) .. ([xshift=-4mm]est.north)
  node[midway, above=0.6mm, font=\tiny, text=acqua, fill=white, inner sep=1pt]
  {json non utilizzabile};
